...
import SocialIcons from '../layout/verticalIcons'; // Assuming the SocialIcons component is in the same directory
...
const TheStateOfAI: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 text-black rounded-lg shadow-lg font-outfit">
      ...
      <div className="w-full flex justify-center mb-6">
        <img
          src="/blogs_research/deeptrack-blog-1.png" // Replace with the correct image path
          alt="AI Fraud Illustration"
          className="w-full h-111 object-cover shadow-md rounded-lg" // Set height to 444px
        />
      </div>
  ...
  <SocialIcons />
      ...
      <h2 className="font-light mt-8 mb-4 border-b border-gray-700 pb-2 text-3xl md:text-4xl">
      ...
      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li>
          <strong className="text-gray-600">Deepfakes:</strong> AI-generated videos used to manipulate, spread misinformation, or impersonate others.
        </li>
        <li>
          <strong className="text-gray-600">Voice Cloning:</strong> AI mimics an individual&apos;s voice to deceive others.
        </li>
        <li>
          <strong className="text-gray-600">AI-Generated Phishing:</strong> Using deep learning to craft highly personalized phishing emails.
        </li>
        <li>
          <strong className="text-gray-600">AI-Powered Misinformation:</strong> Manipulating public perception with AI-driven content.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li>
          <strong className="text-gray-600">Use Deepfake Detection Tools:</strong> Platforms like deeptrack analyze media inconsistencies to verify authenticity.
        </li>
        <li>
          <strong className="text-gray-600">Employee Training:</strong> Conduct awareness programs on recognizing AI-based fraud and verifying communications.
        </li>
        <li>
          <strong className="text-gray-600">Strengthen Cybersecurity:</strong> Implement multi-factor authentication, encrypt data, and monitor threats.
        </li>
        <li>
          <strong className="text-gray-600">Leverage AI for Fraud Prevention:</strong> AI models can analyze behavioral patterns to detect anomalies in transactions and communications.
        </li>
      </ul>
