...
const TheAgeOfCoordinatedAttacks: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-8  text-black rounded-lg shadow-lg font-outfit">
      ...
      <p className="text-gray-700 leading-loose text-justify w-full mb-6 text-base md:text-lg">
      ...
      <h2 className="font-light mt-8 mb-4 border-b border-gray-800 pb-2 text-3xl md:text-4xl">
        What Are Coordinated Deepfake Attacks?
      </h2>

      <p className="text-gray-700 leading-loose text-justify text-base md:text-lg">
      ...
      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li>
          <strong className="text-gray-600">A video call with a “CEO”</strong> authorizing a
          high-value transaction, followed by a Slack message confirming the same.
        </li>
        <li>
          <strong className="text-gray-600">A cloned voice:</strong> posing as a finance
          director calling in with urgency, paired with a realistic-looking invoice via email.
        </li>
        <li>
          <strong className="text-gray-600">AI-generated LinkedIn profiles or spoofed websites </strong> 
          used to legitimize fraudulent outreach or KYC scams.
        </li>
      </ul>

      <p className="text-lg text-gray-700 mt-2 leading-loose text-justify md:text-lg">
      ...
      <ol className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li>
          <strong className="text-gray-600">Developer Platform Deepfake Breach:</strong> A well-known software company
        ...
        <li>
          <strong className="text-gray-600">Full-Scale Investment Scam:</strong> Fraudsters constructed a complete 
        ...
        <li>
          <strong className="text-gray-600">CFO Deepfake Video Call in Asia:</strong> An employee at a multinational
      ...
      <h2 className="text-2xl font-light mt-8 mb-4 border-b border-gray-700 pb-2 md:text-4xl">
        Why Traditional Defenses Fail
      </h2>

      <p className="text-lg text-gray-700 leading-loose text-justify md:text-lg">
      ...
      <h3 className="text-2xl font-light mt-8 mb-4 border-b border-gray-700 pb-2 md:text-4xl">
        Here&apos;s where traditional tools break down:
      </h3>

      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li><strong className="text-gray-600">Email filters</strong> can’t detect synthetic voices or deepfake videos embedded in attachments or links.</li>
        <li><strong className="text-gray-600">Call centers and video conferencing tools</strong> have no built-in deepfake detection.</li>
        <li><strong className="text-gray-600">Human judgment fails</strong> under pressure when voices and faces seem convincingly real.</li>
        <li><strong className="text-gray-600">Security training</strong> is not enough when deception hits across voice, video, email, and chat all at once.</li>
      </ul>
      ...
      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li>
          <strong className="text-gray-600">Multimodal Deepfake Detection</strong> - deeptrack analyzes video, voice,
        ...
        <li>
          <strong className="text-gray-600">Cross-Channel Monitoring</strong> From call centers and Zoom meetings to
        ...
        <li>
          <strong className="text-gray-600">Alerting + Forensics</strong> deeptrack seamlessly feeds alerts into your SIEM,
           SOAR, or incident response workflows, supported by forensic reporting for compliance, investigations,
            and legal documentation.
        </li>
        <li>
          <strong className="text-gray-600">Simulation & Preparedness</strong> We help teams simulate synthetic media attacks
      ...
      <h4 className="text-2xl font-light mt-8 mb-4 border-b border-gray-700 pb-2 md:text-4xl">
        Here’s what leading teams are doing:
      </h4>

      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4 mb-12">
        <li><strong className="text-gray-600">Deploying AI-native defense tools</strong> purpose-built to analyze and respond to synthetic media.</li>
        <li><strong className="text-gray-600">Training teams on coordinated AI fraud</strong> using real-world deepfake simulations.</li>
        <li><strong className="text-gray-600">Updating incident response protocols</strong> to include forensic review of audio, video, and identity signals.</li>
        <li><strong className="text-gray-600">Building secure communication layers</strong> that validate sender identity beyond visual or vocal signals.</li>
      </ul>
    </div>
  );
};
