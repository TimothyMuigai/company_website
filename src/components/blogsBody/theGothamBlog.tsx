...
const TheGothamBlog: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 text-black rounded-lg shadow-lg font-outfit">
      ...
      <p className="text-gray-700 leading-loose text-justify text-base md:text-lg mb-6">
      ...
      <ul className="list-disc ml-6 text-lg text-gray-700 space-y-4">
        <li><strong className="text-gray-600">Real-Time Detection:</strong> Instantly analyze audio, video, and images to flag potential deepfakes.</li>
        <li><strong className="text-gray-600">C2PA-Aligned Verification:</strong> Built with global standards for content provenance and authenticity.</li>
        <li><strong className="text-gray-600">Flexible Integration:</strong> Access Gotham via API or dashboard, tailored for both technical and editorial teams.</li>
        <li><strong className="text-gray-600">Actionable Insights:</strong> Clear reports that help journalists make fast, confident publishing decisions.</li>
      </ul>
      ...
      <p className="text-gray-700 leading-loose text-justify text-base md:text-lg mb-6">
        ...
        <a href="https://www.deeptrack.io" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-bold hover:underline">
          www.deeptrack.io
        </a>{' '}
