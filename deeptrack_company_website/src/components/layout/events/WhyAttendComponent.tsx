...
export default function WhyAttend() {
    return (
        ...
        <div className="rounded-xl p-8">
            <h3 className="text-2xl text-gray-900 mb-4 text-center">Why Attend deeptrack Events?</h3>
            <div className="grid md:grid-cols-3 gap-6 text-center pt-6">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <h4 className="text-lg mb-2 text-gray-800">Expert Insights</h4>
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <h4 className="text-lg mb-2 text-gray-800">Hands-on Training</h4>
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <h4 className="text-lg mb-2 text-gray-800">Networking</h4>
