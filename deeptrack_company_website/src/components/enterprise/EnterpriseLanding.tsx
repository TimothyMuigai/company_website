        ...
        <section className="border-b border-[#CCE9F8] bg-[#F2F9FD]">
          <div className="mx-auto grid max-w-[1440px] gap-10 px-5 py-14 lg:grid-cols-[1.08fr_.92fr] lg:px-10 lg:py-24">
            <div className="flex max-w-3xl flex-col justify-center">
              <div className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#0191DA]"><span className="flex gap-1"><i className="block h-3 w-[3px] bg-[#0191DA]" /><i className="mt-1 block h-2 w-[3px] bg-[#34A7E1]" /><i className="mt-2 block h-1 w-[3px] bg-[#67BDE9]" /></span>Enterprise due diligence</div><p className="mt-5 font-[family-name:var(--font-space-grotesk)] text-xl font-semibold tracking-[-0.03em] text-[#0191DA] sm:text-2xl">A due diligence company.</p>
