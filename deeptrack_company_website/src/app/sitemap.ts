...
const staticPages: MetadataRoute.Sitemap = [
  ...
  {
    url: `${BASE_URL}/industries/insurance`,
    lastModified: now,
    changeFrequency: 'monthly',
    priority: 0.85,
  },
  {
    url: `${BASE_URL}/industries/media`,
    lastModified: now,
    changeFrequency: 'monthly',
    priority: 0.85,
  },
  {
    url: `${BASE_URL}/industries/government`,
    lastModified: now,
    changeFrequency: 'monthly',
    priority: 0.85,
  },
  {
    url: `${BASE_URL}/industries/flexible-workspaces`,
    lastModified: now,
    changeFrequency: 'monthly',
    priority: 0.85,
  },
...
function omitBuildTimestamp(entries: MetadataRoute.Sitemap): MetadataRoute.Sitemap {
  return entries.map(({ lastModified, ...entry }) => entry)
}
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return omitBuildTimestamp([...staticPages, ...blogPages, ...careerPages])
}
